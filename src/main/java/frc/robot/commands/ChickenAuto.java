...
public class ChickenAuto extends SequentialCommandGroup {
  /** Creates a new ChickenAuto. */
  public ChickenAuto(SwerveDrive driveSwerve, Joystick driverL, Joystick driverR, Shooter noteShooter, Intake inTake, Pivot shooterPivot) {
