...
public class TwoNoteRightAuto extends SequentialCommandGroup {
  /** Creates a new TwoNoteRightAuto. */
  public TwoNoteRightAuto(SwerveDrive driveSwerve, Joystick driverL, Joystick driverR, Shooter noteShooter, Intake inTake, Pivot shooterPivot) {
    ...
    addCommands(
      ...
      (new Drive(driveSwerve, driverL, driverR, 0, -.35, 0, true).alongWith(new ShooterIntake(noteShooter, inTake, Constants.shooterIntakeSpeed))).raceWith(new WaitCommand(1.7)),
      new Drive(driveSwerve, driverL, driverR, 0, 0, 0, true).raceWith(new WaitCommand(0.25)),
      new Drive(driveSwerve, driverL, driverR, 0, .35, 0, true).raceWith(new WaitCommand(1.7)),
