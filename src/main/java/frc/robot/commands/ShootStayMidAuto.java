...
public class ShootStayMidAuto extends SequentialCommandGroup {
  /** Creates a new ShootStayAuto. */
  public ShootStayMidAuto(SwerveDrive driveSwerve, Joystick driverL, Joystick driverR, Shooter noteShooter, Intake inTake, Pivot shooterPivot) {
