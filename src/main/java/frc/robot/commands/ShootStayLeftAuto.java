...
public class ShootStayLeftAuto extends SequentialCommandGroup {
  /** Creates a new ShootStayLeftAuto. */
  public ShootStayLeftAuto(SwerveDrive driveSwerve, Joystick driverL, Joystick driverR, Shooter noteShooter, Intake inTake, Pivot shooterPivot) {
