...
public class PickAndLeaveAmpAuto extends SequentialCommandGroup {
  /** Creates a new PickAndLeaveAuto. */
  public PickAndLeaveAmpAuto(SwerveDrive driveSwerve, Joystick driverL, Joystick driverR, Shooter noteShooter, Intake inTake, Pivot shooterPivot) {
